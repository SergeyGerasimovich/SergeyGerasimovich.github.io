...
$form['form-1'] = array(
	...
	'cfg' => array(
		...
		'from_name' => 'noreply',
		'to_email' => 'serhiiherasymovych@gmail.com',
		'to_name' => 'noreply1',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'okay' => 'Благадорим за заявку в ближайшее время с Вами свяжется менеджер',
		'fuck' => 'Произошла ошибка. Попробуйте попытку позже',
		'spam' => 'Cпам робот',
